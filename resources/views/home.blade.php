  ...
  <body>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="/Hospital/public/image/mother.jpg" alt="First slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Brinda Una Mejor Atencion</h1>

              </div>
          </div>
        </div>
        <div class="item">
          <img class="second-slide" src="/Hospital/public/image/medico.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img class="third-slide" src="/Hospital/public/image/brazalete.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p>RFID (Radio Frequency IDentification, en español identificación por radiofrecuencia) 
             ...
             (automatic identification, o identificación automática</p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
          <img class="img-circle" src="/Hospital/public/image/arduino.jpg" width="140" height="140">
          <h2>Arduino</h2>
          <p>  Arduino es una plataforma de hardware de código abierto, basada en una sencilla placa con entradas y
      ...
      <div class="row featurette">
        ...
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block" src="/Hospital/public/image/mision.png" >
        </div>
      </div>
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Objetivos </h2>
          <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
        </div>
        <div class="col-md-5">
          <img class="featurette-image img-responsive center-block"src="/Hospital/public/image/objetivos.png" >
        </div>
      </div>
      ...
      <footer>
        ...
        <p>&copy; 2016 Universidad Mesoamericana , Proyecto. &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
